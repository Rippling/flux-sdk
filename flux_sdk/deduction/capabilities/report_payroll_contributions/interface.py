...
from flux_sdk.pension.capabilities.report_payroll_contributions.interface import ReportPayrollContributions


class ReportPayrollContribution(ReportPayrollContributions, ABC):
