...
from flux_sdk.benefits_administration.capabilities.report_employees_personal_and_employment_data.data_models import ReportEmployeesPersonalAndEmploymentDataConfig, EmployeeBenefitsEligibilityData
...
class ReportEmployeesPersonalAndEmploymentData(ABC):
    ...
    @staticmethod
    @abstractmethod
    def formated_employees_peronal_and_employment_data(config: ReportEmployeesPersonalAndEmploymentDataConfig, employee_data: list[EmployeeBenefitsEligibilityData]) -> File:
        """
