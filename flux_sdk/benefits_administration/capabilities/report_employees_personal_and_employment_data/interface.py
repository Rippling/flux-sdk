...
class ReportEmployeesPersonalAndEmploymentData(ABC):
    ...
    @staticmethod
    @abstractmethod
    def get_formated_employees_peronal_and_employment_data_file(config: ReportEmployeesPersonalAndEmploymentDataConfig, employee_data: list[EmployeeData]) -> File:
        """
